...
import { type FinalizedTxData, type PrivateStateId, type VerifierKey } from '@midnight-ntwrk/midnight-js-types';
 ...
 */
export declare const createCallTxOptions: <C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C>>(compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
circuitId: ICK, contractAddress: ContractAddress, privateStateId: PrivateStateId | undefined, args: Contract.CircuitParameters<C, ICK>) => CallTxOptions<C, ICK>;
/**
 ...
 */
export declare const createCircuitCallTxInterface: <C extends Contract.Any>(providers: ContractProviders<C>, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
contractAddress: ContractAddress, privateStateId: PrivateStateId | undefined) => CircuitCallTxInterface<C>;
/**
 ...
 */
export declare const createCircuitMaintenanceTxInterface: <C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C>>(providers: ContractProviders<C, ICK>, circuitId: ICK, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
contractAddress: ContractAddress) => CircuitMaintenanceTxInterface;
/**
 ...
 * @param contractAddress The ledger address of the contract.
 */
export declare const createCircuitMaintenanceTxInterfaces: <C extends Contract.Any>(providers: ContractProviders<C>, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
contractAddress: ContractAddress) => CircuitMaintenanceTxInterfaces<C>;
/**
 ...
 * @param contractAddress The ledger address of the contract.
 */
export declare const createContractMaintenanceTxInterface: <C extends Contract.Any>(providers: ContractProviders, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
contractAddress: ContractAddress) => ContractMaintenanceTxInterface;
