...
import { type PartitionedTranscript, type ZswapChainState } from '@midnight-ntwrk/ledger-v7';
/**
 ...
 */
export type CallOptionsWithArguments<C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C>> = Contract.CircuitParameters<C, ICK> extends [] ? CallOptionsBase<C, ICK> : CallOptionsBase<C, ICK> & {
    /**
 ...
 */
export type CallOptionsWithProviderDataDependencies<C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C>> = CallOptionsWithArguments<C, ICK> & CallOptionsProviderDataDependencies;
/**
 * Call options for contracts with private state.
 */
export type CallOptionsWithPrivateState<C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C>> = CallOptionsWithProviderDataDependencies<C, ICK> & {
    /**
 ...
 */
export type CallOptions<C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C>> = CallOptionsWithProviderDataDependencies<C, ICK> | CallOptionsWithPrivateState<C, ICK>;
/**
