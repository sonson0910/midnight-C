...
export declare class TxFailedError extends Error {
    ...
    readonly circuitId?: (Contract.ImpureCircuitId<Contract.Any> | Contract.ImpureCircuitId<Contract.Any>[]) | undefined;
    /**
     ...
     *                  failed.
     */
    constructor(finalizedTxData: FinalizedTxData, circuitId?: (Contract.ImpureCircuitId<Contract.Any> | Contract.ImpureCircuitId<Contract.Any>[]) | undefined);
}
/**
...
export declare class CallTxFailedError extends TxFailedError {
     ...
     */
    constructor(finalizedTxData: FinalizedTxData, circuitId: Contract.ImpureCircuitId<Contract.Any> | Contract.ImpureCircuitId<Contract.Any>[]);
}
/**
...
export declare class ContractTypeError extends TypeError {
     ...
     */
    constructor(contractState: ContractState, circuitIds: Contract.ImpureCircuitId<Contract.Any>[]);
}
/**
