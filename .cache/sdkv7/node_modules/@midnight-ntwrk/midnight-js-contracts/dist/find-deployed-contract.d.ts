...
import { type PrivateStateId, type VerifierKey } from '@midnight-ntwrk/midnight-js-types';
 ...
 */
export declare const verifyContractState: (verifierKeys: [Contract.ImpureCircuitId<Contract.Any>, VerifierKey][], contractState: ContractState) => void;
/**
...
export declare function findDeployedContract<C extends Contract<undefined>>(providers: ContractProviders<C, Contract.ImpureCircuitId<C>, unknown>, options: FindDeployedContractOptionsBase<C>): Promise<FoundContract<C>>;
