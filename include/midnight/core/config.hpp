...
struct NetworkConfig {
  ...
  // === PRIVACY (Official) ===
  static constexpr const char *PROOF_SYSTEM = "PLONK";
  static constexpr uint32_t DEFAULT_PROOF_SIZE_BYTES = 128; // Fee-estimation hint only
...
struct PreprodConfig {
  ...
  static std::string get_node_rpc_endpoint() {
    ...
    static const std::string cached =
        std::string(NODE_RPC_PROTOCOL) + "://" + NODE_RPC_HOST;
    return cached;
  }
  ...
  // === FAUCET (Official) ===
  static constexpr const char *FAUCET_URL =
      "https://faucet.preprod.midnight.network/";
  static constexpr const char *FAUCET_TOKEN = "tNIGHT";

  // === EXPLORER (Official) ===
  static constexpr const char *EXPLORER_URL =
